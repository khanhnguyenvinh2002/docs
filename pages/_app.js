...
import { SideNav, TableOfContents, TopNav } from '../components/Shell';
...
const TITLE = 'HyperEdge Labs Docs';
const DESCRIPTION = 'Instruction how to use HyperEdge Labs';
  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:url" content="https://hyperedgelabs.xyz" />
